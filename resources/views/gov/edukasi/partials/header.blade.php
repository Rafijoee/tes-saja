<div class="flex flex-row w-[1231px] h-12 m-4 rounded bg-[#7FC7D9] items-center p-2">
    <div class="flex flex-row w-full items-center">
        ...
        <ul class="relative max-w-6xl flex flex-row overflow-x-auto text-sm font-medium text-center"
            ...
            @foreach ($jenis as $item)
                <li class="me-2" role="presentation">
                    <a href="/pemerintah/edukasi/{{ $item->id }}" rel="noopener noreferrer"><button
    ...
    {{-- <button id="buttonJenisModal" type="submit" data-modal-target="tambahJenisModal"
        data-modal-toggle="tambahJenisModal"
