        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5">
                    <form class="space-y-4" method="post" action="{{ route('admin.edukasi.materi.store') }}">
                        @csrf
                        @method('post')
                        <div>
                            <label for="judulEdu"
            ...
            @foreach ($item->subMateri as $item)
                <ul class="text-base mb-2">
                    <li class="underline"><a
                            href="/admin/edukasi/{{ $first->id }}/{{ $item->id }}">{{ $item->judul }} </a></li>
                </ul>
            @endforeach
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="p-4 md:p-5">
                            <form class="space-y-4" enctype="multipart/form-data" method="post"
                                action="{{ route('admin.edukasi.sub') }}">
                                @csrf
                                @method('post')
                                <div>
                                    <label for="judulEdu"
