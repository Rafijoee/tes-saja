      ...
      <div class="bg-[#D6E8EE] rounded px-14 pt-12">
        ...
        <div class="py-6 text-lg h-auto">
          <div class="grid grid-cols-[25%_75%] mb-4">
            ...
            <div>
              <span class="font-light">Faiq Ammar</span>
          ...
          <div class="grid grid-cols-[25%_75%] mb-4">
            ...
            <div>
              <span class="font-light">faiqammar165@gmail.com</span>
              <hr class="border border-black rounded">
            </div>
          </div>
          <div class="grid grid-cols-[25%_75%] mb-4">
            ...
            <div>
              <span class="font-light">faiqammar</span>
              <hr class="border border-black rounded">
            </div>
          </div>
          <div class="grid grid-cols-[25%_75%] mb-4">
            ...
            <div>
              <span class="font-light">089364728192</span>
              <hr class="border border-black rounded">
            </div>
          </div>
          <div class="grid grid-cols-[25%_75%] mb-4">
          ...
          <div class="grid grid-cols-[25%_75%] mb-4">
            ...
            <div>
              <span class="font-light">Jl. Mastrip no 56, Sumber Sari, Jember, Jawa Timur</span>
              <hr class="border border-black rounded">
            </div>
          </div>
        </div>
